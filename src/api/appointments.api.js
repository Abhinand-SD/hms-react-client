...
export const getBookedTokens      = (params)   => api.get('/appointments/booked-tokens', { params });
...
export const checkInAppointment   = (id, data = {}) => api.post(`/appointments/${id}/check-in`, data);
